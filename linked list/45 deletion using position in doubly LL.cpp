...
void deleteNode(node* &head, int pos)
{
    ...
    else
    {
        ...
        // below statement is to deal with the case of tail node
        // when the element is at tail, curr->next points to NULL
        // so we cannot have statement as curr->next->prev
        if(curr->next!=NULL)          
        {
